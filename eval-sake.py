...
img_basic.show()
img_basic.save('basic_wline.png')
...
img_adv.show()
img_adv.save('adv_wline.png')




### Wine-basic graph drawing
...
target_drawing = draw_wine_basic
...
for unknown_value in unknown:
    ...
    if unknown_value and dummy == 1:
        if unknown[dummy-1]:
            target_drawing.line([(type_x, type_y), (rice_x, rice_y)], fill = light_color, width = 8, joint="curve")
        if not unknown[dummy-1]:
            target_drawing.line([(type_x, type_y), (type_x+(rice_x-type_x)/2, type_y+(rice_y-type_y)/2)], fill = solid_color, width = 8, joint="curve")
            target_drawing.line([(type_x+(rice_x-type_x)/2, type_y+(rice_y-type_y)/2), (rice_x, rice_y)], fill = light_color, width = 8, joint="curve") 

    if not unknown_value and dummy == 1:
        if not unknown[dummy-1]:
            target_drawing.line([(type_x, type_y), (rice_x, rice_y)], fill = solid_color, width = 8, joint="curve")
        if unknown[dummy-1]:
            target_drawing.line([(type_x, type_y), (type_x+(rice_x-type_x)/2, type_y+(rice_y-type_y)/2)], fill = light_color, width = 8, joint="curve")
            target_drawing.line([(type_x+(rice_x-type_x)/2, type_y+(rice_y-type_y)/2), (rice_x, rice_y)], fill = solid_color, width = 8, joint="curve") 

    if unknown_value and dummy == 2:
        if unknown[dummy-1]:
            target_drawing.line([(rice_x, rice_y), (shubo_x, shubo_y)], fill = light_color, width = 8, joint="curve")
        if not unknown[dummy-1]:
            target_drawing.line([(rice_x, rice_y), (rice_x+(shubo_x-rice_x)/2, rice_y+(shubo_y-rice_y)/2)], fill = solid_color, width = 8, joint="curve")
            target_drawing.line([(rice_x+(shubo_x-rice_x)/2, rice_y+(shubo_y-rice_y)/2), (shubo_x, shubo_y)], fill = light_color, width = 8, joint="curve") 

    if not unknown_value and dummy == 2:
        if not unknown[dummy-1]:
            target_drawing.line([(rice_x, rice_y), (shubo_x, shubo_y)], fill = solid_color, width = 8, joint="curve")
        if unknown[dummy-1]:
            target_drawing.line([(rice_x, rice_y), (rice_x+(shubo_x-rice_x)/2, rice_y+(shubo_y-rice_y)/2)], fill = light_color, width = 8, joint="curve")
            target_drawing.line([(rice_x+(shubo_x-rice_x)/2, rice_y+(shubo_y-rice_y)/2), (shubo_x, shubo_y)], fill = solid_color, width = 8, joint="curve") 


    dummy += 1

if not unknown[2]:
    target_drawing.line([(shubo_x, shubo_y), (result_x, result_y)], fill = solid_color, width = 8, joint="curve")
else:
    target_drawing.line([(shubo_x, shubo_y), (shubo_x+(result_x-shubo_x)/3, shubo_y+(result_y-shubo_y)/3)], fill = light_color, width = 8, joint="curve")
    target_drawing.line([(shubo_x+(result_x-shubo_x)/3, shubo_y+(result_y-shubo_y)/3), (result_x, result_y)], fill = solid_color, width = 8, joint="curve") 


img_wine_basic.show()
img_wine_basic.save('basic-wine_wline.png')



### Wine-advanced graph drowing
...
target_drawing = draw_wine_adv

dummy = 0

for unknown_value in unknown_1:
    if not unknown_value and dummy == 0:
        target_drawing.line([(start_x_adv, start_y_adv), (type_x_adv, type_y_adv)], fill = solid_color, width = 8, joint="curve")
    
    if unknown_value and dummy == 0:
        target_drawing.line([(start_x_adv, start_y_adv), (type_x_adv, type_y_adv)], fill = light_color, width = 8, joint="curve")
    
    if unknown_value and dummy == 1:
        if unknown_1[dummy-1]:
            target_drawing.line([(type_x_adv, type_y_adv), (rice_x_adv, rice_y_adv)], fill = light_color, width = 8, joint="curve")
        if not unknown_1[dummy-1]:
            target_drawing.line([(type_x_adv, type_y_adv), (type_x_adv+(rice_x_adv-type_x_adv)/2, type_y_adv+(rice_y_adv-type_y_adv)/2)], fill = solid_color, width = 8, joint="curve")
            target_drawing.line([(type_x_adv+(rice_x_adv-type_x_adv)/2, type_y_adv+(rice_y_adv-type_y_adv)/2), (rice_x_adv, rice_y_adv)], fill = light_color, width = 8, joint="curve") 

    if not unknown_value and dummy == 1:
        if not unknown_1[dummy-1]:
            target_drawing.line([(type_x_adv, type_y_adv), (rice_x_adv, rice_y_adv)], fill = solid_color, width = 8, joint="curve")
        if unknown_1[dummy-1]:
            target_drawing.line([(type_x_adv, type_y_adv), (type_x_adv+(rice_x_adv-type_x_adv)/2, type_y_adv+(rice_y_adv-type_y_adv)/2)], fill = light_color, width = 8, joint="curve")
            target_drawing.line([(type_x_adv+(rice_x_adv-type_x_adv)/2, type_y_adv+(rice_y_adv-type_y_adv)/2), (rice_x_adv, rice_y_adv)], fill = solid_color, width = 8, joint="curve") 

    if unknown_value and dummy == 2:
        if unknown_1[dummy-1]:
            target_drawing.line([(rice_x_adv, rice_y_adv), (shubo_x_adv, shubo_y_adv)], fill = light_color, width = 8, joint="curve")
        if not unknown_1[dummy-1]:
            target_drawing.line([(rice_x_adv, rice_y_adv), (rice_x_adv+(shubo_x_adv-rice_x_adv)/2, rice_y_adv+(shubo_y_adv-rice_y_adv)/2)], fill = solid_color, width = 8, joint="curve")
            target_drawing.line([(rice_x_adv+(shubo_x_adv-rice_x_adv)/2, rice_y_adv+(shubo_y_adv-rice_y_adv)/2), (shubo_x_adv, shubo_y_adv)], fill = light_color, width = 8, joint="curve") 

    if not unknown_value and dummy == 2:
        if not unknown_1[dummy-1]:
            target_drawing.line([(rice_x_adv, rice_y_adv), (shubo_x_adv, shubo_y_adv)], fill = solid_color, width = 8, joint="curve")
        if unknown_1[dummy-1]:
            target_drawing.line([(rice_x_adv, rice_y_adv), (rice_x_adv+(shubo_x_adv-rice_x_adv)/2, rice_y_adv+(shubo_y_adv-rice_y_adv)/2)], fill = light_color, width = 8, joint="curve")
            target_drawing.line([(rice_x_adv+(shubo_x_adv-rice_x_adv)/2, rice_y_adv+(shubo_y_adv-rice_y_adv)/2), (shubo_x_adv, shubo_y_adv)], fill = solid_color, width = 8, joint="curve") 

    if unknown_value and dummy == 3:
        if unknown_1[dummy-1]:
            target_drawing.line([(shubo_x_adv, shubo_y_adv), (yeast_x_adv, yeast_y_adv)], fill = light_color, width = 8, joint="curve")
        if not unknown_1[dummy-1]:
            target_drawing.line([(shubo_x_adv, shubo_y_adv), (shubo_x_adv+(yeast_x_adv-shubo_x_adv)/2, shubo_y_adv+(yeast_y_adv-shubo_y_adv)/2)], fill = solid_color, width = 8, joint="curve")
            target_drawing.line([(shubo_x_adv+(yeast_x_adv-shubo_x_adv)/2, shubo_y_adv+(yeast_y_adv-shubo_y_adv)/2), (yeast_x_adv, yeast_y_adv)], fill = light_color, width = 8, joint="curve") 

    if not unknown_value and dummy == 3:
        if not unknown_1[dummy-1]:
            target_drawing.line([(shubo_x_adv, shubo_y_adv), (yeast_x_adv, yeast_y_adv)], fill = solid_color, width = 8, joint="curve")
        if unknown_1[dummy-1]:
            target_drawing.line([(shubo_x_adv, shubo_y_adv), (shubo_x_adv+(yeast_x_adv-shubo_x_adv)/2, shubo_y_adv+(yeast_y_adv-shubo_y_adv)/2)], fill = light_color, width = 8, joint="curve")
            target_drawing.line([(shubo_x_adv+(yeast_x_adv-shubo_x_adv)/2, shubo_y_adv+(yeast_y_adv-shubo_y_adv)/2), (yeast_x_adv, yeast_y_adv)], fill = solid_color, width = 8, joint="curve")
...
for unknown_value in unknown_2:
    if unknown_value and dummy == 0:
        if unknown_1[-1]:
            target_drawing.line([(amino_x_adv, amino_y_adv), (acid_x_adv, acid_y_adv)], fill = light_color, width = 8, joint="curve")
        if not unknown_1[-1]:
            target_drawing.line([(amino_x_adv, amino_y_adv), (amino_x_adv+(acid_x_adv-amino_x_adv)/2, amino_y_adv+(acid_y_adv-amino_y_adv)/2)], fill = solid_color, width = 8, joint="curve")
            target_drawing.line([(amino_x_adv+(acid_x_adv-amino_x_adv)/2, amino_y_adv+(acid_y_adv-amino_y_adv)/2), (acid_x_adv, acid_y_adv)], fill = light_color, width = 8, joint="curve") 

    if not unknown_value and dummy == 0:
        if not unknown_1[-1]:
            target_drawing.line([(amino_x_adv, amino_y_adv), (acid_x_adv, acid_y_adv)], fill = solid_color, width = 8, joint="curve")
        if unknown_1[-1]:
            target_drawing.line([(amino_x_adv, amino_y_adv), (amino_x_adv+(acid_x_adv-amino_x_adv)/2, amino_y_adv+(acid_y_adv-amino_y_adv)/2)], fill = light_color, width = 8, joint="curve")
            target_drawing.line([(amino_x_adv+(acid_x_adv-amino_x_adv)/2, amino_y_adv+(acid_y_adv-amino_y_adv)/2), (acid_x_adv, acid_y_adv)], fill = solid_color, width = 8, joint="curve") 
   


    if unknown_value and dummy == 1:
        if unknown_2[dummy-1]:
            target_drawing.line([(acid_x_adv, acid_y_adv), (smv_x_adv, smv_y_adv)], fill = light_color, width = 8, joint="curve")
        if not unknown_2[dummy-1]:
            target_drawing.line([(acid_x_adv, acid_y_adv), (acid_x_adv+(smv_x_adv-acid_x_adv)/2, acid_y_adv+(smv_y_adv-acid_y_adv)/2)], fill = solid_color, width = 8, joint="curve")
            target_drawing.line([(acid_x_adv+(smv_x_adv-acid_x_adv)/2, acid_y_adv+(smv_y_adv-acid_y_adv)/2), (smv_x_adv, smv_y_adv)], fill = light_color, width = 8, joint="curve") 

    if not unknown_value and dummy == 1:
        if not unknown_2[dummy-1]:
            target_drawing.line([(acid_x_adv, acid_y_adv), (smv_x_adv, smv_y_adv)], fill = solid_color, width = 8, joint="curve")
        if unknown_2[dummy-1]:
            target_drawing.line([(acid_x_adv, acid_y_adv), (acid_x_adv+(smv_x_adv-acid_x_adv)/2, acid_y_adv+(smv_y_adv-acid_y_adv)/2)], fill = light_color, width = 8, joint="curve")
            target_drawing.line([(acid_x_adv+(smv_x_adv-acid_x_adv)/2, acid_y_adv+(smv_y_adv-type_y_adv)/2), (smv_x_adv, smv_y_adv)], fill = solid_color, width = 8, joint="curve") 
...
if not unknown_2[1]:
    target_drawing.line([(smv_x_adv, smv_y_adv), (body_x_adv, body_y_adv)], fill = solid_color, width = 8, joint="curve")
else:
    target_drawing.line([(smv_x_adv, smv_y_adv), (smv_x_adv+(body_x_adv-smv_x_adv)/3, smv_y_adv+(body_y_adv-smv_y_adv)/3)], fill = light_color, width = 8, joint="curve")
    target_drawing.line([(smv_x_adv+(body_x_adv-smv_x_adv)/3, smv_y_adv+(body_y_adv-smv_y_adv)/3), (body_x_adv, body_y_adv)], fill = solid_color, width = 8, joint="curve") 


img_wine_adv.show()
img_wine_adv.save('adv-wine_wline.png')
